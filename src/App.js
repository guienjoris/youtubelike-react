...
class App extends React.Component { 
  ...
  return (
   ...
   <iframe src={this.state.video}></iframe>
   <p>{this.state.synopsis}</p>
   </div>
   <div className="container_suggestions">
   <p>Suggestions</p>
   <div>
     <img className="block_suggestion"src={this.state.image1}></img>
   </div>
   <div>
   <img className="block_suggestion"src={this.state.image2}></img>

   </div>
   <div >
   <img className="block_suggestion" src={this.state.image3}></img>
